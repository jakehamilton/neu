...
const parseKeypress = (s: Buffer | string = ""): Key => {
	let parts;

	// NOTE: Avoids issues with Vite thinking this code is used in the browser.
	if (globalThis.Buffer && globalThis.Buffer.isBuffer(s)) {
